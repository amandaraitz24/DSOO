...
class ControladorPrincipal:
    ...
    def __init__(self):
        ...
        self.profissional_padrao = Profissional(
            "Dr. Carlos",
            "48999999999",
            "12345678900",
            "Geral",
        ...
        self.tipo_padrao = TipoAtendimento(
            "Consulta Padrão"
        )
    ...
    def iniciar_sistema(self):
        ...
        while True:
            ...
            if opcao == '1':
                ...
                self.__controlador_relatorio.menu_relatorios()

            elif opcao == '6':
                self.__controlador_agendamento.abre_tela()

            elif opcao == '7':
                self.__controlador_exame.abre_tela()
